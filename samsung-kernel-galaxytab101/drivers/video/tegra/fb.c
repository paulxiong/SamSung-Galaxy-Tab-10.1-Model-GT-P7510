...
#ifdef CONFIG_BOOSTX_DEBUG_FB
/*boostx: debug, print a open information while this fb is being open*/
	printk("boostx:tegra_fb_open\n");
#endif
	if (atomic_xchg(&tegra_fb->in_use, 1))
#ifdef CONFIG_BOOSTX_FB
		;
#else
		return -EBUSY;
#endif
#ifdef CONFIG_BOOSTX_DEBUG_FB
	printk("boostx:tegra_fb_open successful!\n");
#endif
